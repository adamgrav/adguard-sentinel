...
- `docs/SUPPORT.md` — what is supported, and what is deliberately not offered.
...
- Schema or output changes follow `RELEASING.md`, which records how the binary,
  the configuration, the run report, and the SQLite state version independently.
